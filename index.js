...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.r1jb7.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
  try {
     ...
     * app.put('/booking/:id') // upsert ==> update (if exists) or insert (if don't exist)
